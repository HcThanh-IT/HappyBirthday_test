...
const contentLetterSrart_actived = "HAPPY BIRTHDAY BÉ RÙA " //Lời mở đầu cho bức thư
const mainContentLetter = "Tình yêu của tui chính là bạn, bạn là một người đặc biệt không thể thiếu trong cuộc sống với tui nếu mà á có 1 lí do nào đó khiến chúng ta không thể gặp nhau nữa thì tui sẽ tìm hàng nghìn hàng trăm lí do để khiến chúng ta ở bên cạnh nhau. Hôm nay là ngày đặc biệt của bạn em bé của tui lại lớn thêm 1 tuổi nữa rồi sinh nhật năm nay có tui với bạn đó là điều hạnh phúc nhất của tôi rồi chúc bạn gặp thật nhiều may mắn trong học tập và có gia đình hạnh phúc mong bạn sớm sẽ là của tui kkk mong mọi điều may mắn sẽ tới với bạn. HAPPY BIRTHDAY BÉ RÙA CỦA TÂN 🎂🎂🎂" //Nội dung của bức thư
